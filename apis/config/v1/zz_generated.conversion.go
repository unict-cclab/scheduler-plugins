...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*ArchitectureAwareArgs)(nil), (*config.ArchitectureAwareArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ArchitectureAwareArgs_To_config_ArchitectureAwareArgs(a.(*ArchitectureAwareArgs), b.(*config.ArchitectureAwareArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.ArchitectureAwareArgs)(nil), (*ArchitectureAwareArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_ArchitectureAwareArgs_To_v1_ArchitectureAwareArgs(a.(*config.ArchitectureAwareArgs), b.(*ArchitectureAwareArgs), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*DeviceFactoreMapping)(nil), (*config.DeviceFactoreMapping)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_DeviceFactoreMapping_To_config_DeviceFactoreMapping(a.(*DeviceFactoreMapping), b.(*config.DeviceFactoreMapping), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.DeviceFactoreMapping)(nil), (*DeviceFactoreMapping)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_DeviceFactoreMapping_To_v1_DeviceFactoreMapping(a.(*config.DeviceFactoreMapping), b.(*DeviceFactoreMapping), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*DeviceMapping)(nil), (*config.DeviceMapping)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_DeviceMapping_To_config_DeviceMapping(a.(*DeviceMapping), b.(*config.DeviceMapping), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.DeviceMapping)(nil), (*DeviceMapping)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_DeviceMapping_To_v1_DeviceMapping(a.(*config.DeviceMapping), b.(*DeviceMapping), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*NetworkAwareArgs)(nil), (*config.NetworkAwareArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_NetworkAwareArgs_To_config_NetworkAwareArgs(a.(*NetworkAwareArgs), b.(*config.NetworkAwareArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.NetworkAwareArgs)(nil), (*NetworkAwareArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NetworkAwareArgs_To_v1_NetworkAwareArgs(a.(*config.NetworkAwareArgs), b.(*NetworkAwareArgs), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*QoSAwareArgs)(nil), (*config.QoSAwareArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_QoSAwareArgs_To_config_QoSAwareArgs(a.(*QoSAwareArgs), b.(*config.QoSAwareArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.QoSAwareArgs)(nil), (*QoSAwareArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_QoSAwareArgs_To_v1_QoSAwareArgs(a.(*config.QoSAwareArgs), b.(*QoSAwareArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_ArchitectureAwareArgs_To_config_ArchitectureAwareArgs(in *ArchitectureAwareArgs, out *config.ArchitectureAwareArgs, s conversion.Scope) error {
	out.Mappings = *(*[]config.DeviceMapping)(unsafe.Pointer(&in.Mappings))
	return nil
}

// Convert_v1_ArchitectureAwareArgs_To_config_ArchitectureAwareArgs is an autogenerated conversion function.
func Convert_v1_ArchitectureAwareArgs_To_config_ArchitectureAwareArgs(in *ArchitectureAwareArgs, out *config.ArchitectureAwareArgs, s conversion.Scope) error {
	return autoConvert_v1_ArchitectureAwareArgs_To_config_ArchitectureAwareArgs(in, out, s)
}
...
func autoConvert_config_ArchitectureAwareArgs_To_v1_ArchitectureAwareArgs(in *config.ArchitectureAwareArgs, out *ArchitectureAwareArgs, s conversion.Scope) error {
	out.Mappings = *(*[]DeviceMapping)(unsafe.Pointer(&in.Mappings))
	return nil
}

// Convert_config_ArchitectureAwareArgs_To_v1_ArchitectureAwareArgs is an autogenerated conversion function.
func Convert_config_ArchitectureAwareArgs_To_v1_ArchitectureAwareArgs(in *config.ArchitectureAwareArgs, out *ArchitectureAwareArgs, s conversion.Scope) error {
	return autoConvert_config_ArchitectureAwareArgs_To_v1_ArchitectureAwareArgs(in, out, s)
}
...
// Convert_v1_DeviceFactoreMapping_To_config_DeviceFactoreMapping is an autogenerated conversion function.
func Convert_v1_DeviceFactoreMapping_To_config_DeviceFactoreMapping(in *DeviceFactoreMapping, out *config.DeviceFactoreMapping, s conversion.Scope) error {
	return autoConvert_v1_DeviceFactoreMapping_To_config_DeviceFactoreMapping(in, out, s)
}
...
// Convert_config_DeviceFactoreMapping_To_v1_DeviceFactoreMapping is an autogenerated conversion function.
func Convert_config_DeviceFactoreMapping_To_v1_DeviceFactoreMapping(in *config.DeviceFactoreMapping, out *DeviceFactoreMapping, s conversion.Scope) error {
	return autoConvert_config_DeviceFactoreMapping_To_v1_DeviceFactoreMapping(in, out, s)
}

func autoConvert_v1_DeviceMapping_To_config_DeviceMapping(in *DeviceMapping, out *config.DeviceMapping, s conversion.Scope) error {
	out.LabelValue = in.LabelValue
	out.Tag = in.Tag
...
// Convert_v1_DeviceMapping_To_config_DeviceMapping is an autogenerated conversion function.
func Convert_v1_DeviceMapping_To_config_DeviceMapping(in *DeviceMapping, out *config.DeviceMapping, s conversion.Scope) error {
	return autoConvert_v1_DeviceMapping_To_config_DeviceMapping(in, out, s)
}

func autoConvert_config_DeviceMapping_To_v1_DeviceMapping(in *config.DeviceMapping, out *DeviceMapping, s conversion.Scope) error {
	out.LabelValue = in.LabelValue
	out.Tag = in.Tag
	out.BackendsPath = in.BackendsPath
	out.Args = *(*[]string)(unsafe.Pointer(&in.Args))
...
// Convert_config_DeviceMapping_To_v1_DeviceMapping is an autogenerated conversion function.
func Convert_config_DeviceMapping_To_v1_DeviceMapping(in *config.DeviceMapping, out *DeviceMapping, s conversion.Scope) error {
	return autoConvert_config_DeviceMapping_To_v1_DeviceMapping(in, out, s)
}
...
func autoConvert_v1_NetworkAwareArgs_To_config_NetworkAwareArgs(in *NetworkAwareArgs, out *config.NetworkAwareArgs, s conversion.Scope) error {
	if err := metav1.Convert_Pointer_bool_To_bool(&in.IgnoreSameZoneNetworkCost, &out.IgnoreSameZoneNetworkCost, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1_NetworkAwareArgs_To_config_NetworkAwareArgs is an autogenerated conversion function.
func Convert_v1_NetworkAwareArgs_To_config_NetworkAwareArgs(in *NetworkAwareArgs, out *config.NetworkAwareArgs, s conversion.Scope) error {
	return autoConvert_v1_NetworkAwareArgs_To_config_NetworkAwareArgs(in, out, s)
}

func autoConvert_config_NetworkAwareArgs_To_v1_NetworkAwareArgs(in *config.NetworkAwareArgs, out *NetworkAwareArgs, s conversion.Scope) error {
	if err := metav1.Convert_bool_To_Pointer_bool(&in.IgnoreSameZoneNetworkCost, &out.IgnoreSameZoneNetworkCost, s); err != nil {
		return err
	}
	return nil
}

// Convert_config_NetworkAwareArgs_To_v1_NetworkAwareArgs is an autogenerated conversion function.
func Convert_config_NetworkAwareArgs_To_v1_NetworkAwareArgs(in *config.NetworkAwareArgs, out *NetworkAwareArgs, s conversion.Scope) error {
	return autoConvert_config_NetworkAwareArgs_To_v1_NetworkAwareArgs(in, out, s)
}
...
func autoConvert_v1_QoSAwareArgs_To_config_QoSAwareArgs(in *QoSAwareArgs, out *config.QoSAwareArgs, s conversion.Scope) error {
	out.Mappings = *(*[]config.DeviceFactoreMapping)(unsafe.Pointer(&in.Mappings))
	return nil
}

// Convert_v1_QoSAwareArgs_To_config_QoSAwareArgs is an autogenerated conversion function.
func Convert_v1_QoSAwareArgs_To_config_QoSAwareArgs(in *QoSAwareArgs, out *config.QoSAwareArgs, s conversion.Scope) error {
	return autoConvert_v1_QoSAwareArgs_To_config_QoSAwareArgs(in, out, s)
}

func autoConvert_config_QoSAwareArgs_To_v1_QoSAwareArgs(in *config.QoSAwareArgs, out *QoSAwareArgs, s conversion.Scope) error {
	out.Mappings = *(*[]DeviceFactoreMapping)(unsafe.Pointer(&in.Mappings))
	return nil
}

// Convert_config_QoSAwareArgs_To_v1_QoSAwareArgs is an autogenerated conversion function.
func Convert_config_QoSAwareArgs_To_v1_QoSAwareArgs(in *config.QoSAwareArgs, out *QoSAwareArgs, s conversion.Scope) error {
	return autoConvert_config_QoSAwareArgs_To_v1_QoSAwareArgs(in, out, s)
}
